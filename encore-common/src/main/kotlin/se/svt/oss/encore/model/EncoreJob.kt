...
data class SegmentedEncodingInfo(
    ...
    val numSegments: Int,
    @field:Schema(
        description = "Number of encoding tasks used for this job. This is numSegments for ENCODE_WITH_VIDEO, numSegments + 1 for ENCODE_SEPARATELY_FULL, or numSegments + numAudioSegments for ENCODE_SEPARATELY_SEGMENTED.",
        nullable = false,
        readOnly = true,
    )
    val numTasks: Int,
    ...
    @field:Schema(
        description = "Audio segment padding in seconds (added at start/end of segments to avoid artifacts). Only applicable for ENCODE_SEPARATELY_SEGMENTED mode.",
        example = "0.04267",
        nullable = false,
        readOnly = true,
    )
    ...
    @field:Schema(
        description = "Length of each audio segment in seconds. Only applicable for ENCODE_SEPARATELY_SEGMENTED mode.",
        example = "256.0",
        nullable = false,
        readOnly = true,
    )
